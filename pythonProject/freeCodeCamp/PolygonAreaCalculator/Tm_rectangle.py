...
class UnitTests(unittest.TestCase):
    def setUp(self):
        ...
        self.sq = rectangle.Square(5)

    def test_subclass(self):
        actual = issubclass(rectangle.Square,
                            rectangle.Rectangle)
        expected = True
        self.assertEqual(
            actual, expected,
    ...
    def test_distinct_classes(self):
        actual = rectangle.Square is not rectangle.Rectangle
        expected = True
        self.assertEqual(
            actual, expected,
    ...
    def test_square_is_square_and_rectangle(self):
        actual = isinstance(self.sq, rectangle.Square) and isinstance(
            self.sq, rectangle.Square)
        expected = True
        self.assertEqual(
            actual, expected,
